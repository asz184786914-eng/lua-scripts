...
local CDN_URLS = {
    {name = "jsDelivr国内", url = "https://cdn.jsdelivr.net/gh/asz184786914-eng/lua-scripts@9c1e7d6/speed_hack.lua"},
    {name = "Fastly节点",   url = "https://fastly.jsdelivr.net/gh/asz184786914-eng/lua-scripts@9c1e7d6/speed_hack.lua"},
    {name = "CF国内镜像",   url = "https://testingcf.jsdelivr.net/gh/asz184786914-eng/lua-scripts@9c1e7d6/speed_hack.lua"},
    {name = "gcore节点",    url = "https://gcore.jsdelivr.net/gh/asz184786914-eng/lua-scripts@9c1e7d6/speed_hack.lua"},
